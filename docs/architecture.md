...
The included OpenAI-compatible provider demonstrates configurable real endpoints, asynchronous cognition events, and cancellation. It remains a cascade, so it cannot preserve all speech timing and prosody through ASR → text → TTS.
