...
Openlive does not claim experiential parity without measurements. Protocol 0.2 emits generation-scoped `latency_mark` events from the gateway's monotonic clock:
